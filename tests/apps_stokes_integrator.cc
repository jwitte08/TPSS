...
protected:
  ...
  {
    ASSERT_GT(fe_degree_p, 0) << " ... test is expected to fail!";
  ...
  /**
   * is_lmw : If true use LMW::MatrixIntegratorStream otherwise use
   *          FD:MatrixIntegratorStream.
   */
  template<bool is_simplified = false, bool is_lmw = true>
  void
  check_matrixintegratorstream()
  {
    ASSERT_GT(fe_degree_p, 0) << " ... test is expected to fail!";
    ...
    using MatrixIntegrator =
      VelocityPressure::MatrixIntegrator<dim,
                                         fe_degree_p,
                                         double,
                                         TPSS::DoFLayout::RT,
                                         fe_degree_p,
                                         (is_lmw ? LocalAssembly::StreamLMW :
                                                   LocalAssembly::StreamTensor),
                                         is_simplified>;
  ...
  check_localsolverstream(lssVariant lssvariant)
  {
    ...
    using OtherMatrixIntegrator =
      VelocityPressure::LMW::MatrixIntegrator<dim,
                                              fe_degree_p,
                                              double,
                                              TPSS::DoFLayout::RT,
                                              StokesProblem::fe_degree_v,
...
TYPED_TEST_P(TestStokesIntegrator, matrixintegratorfdDGQ_velocity)
{
  using Fixture                               = TestStokesIntegrator<TypeParam>;
  Fixture::options.prms.mesh.geometry_variant = MeshParameter::GeometryVariant::Cube;
  Fixture::options.prms.mesh.n_repetitions    = 2;
  Fixture::options.prms.mesh.n_refinements    = 0;
  Fixture::template check_matrixintegratorfd_velocity<Method::DGQkplus2_DGPk, false>(true);
  Fixture::template check_matrixintegratorfd_velocity<Method::DGQkplus2_DGPk, false>(false);
  Fixture::options.prms.mesh.n_refinements = 1;
  Fixture::template check_matrixintegratorfd_velocity<Method::DGQkplus2_DGPk, false>(true);
  Fixture::template check_matrixintegratorfd_velocity<Method::DGQkplus2_DGPk, false>(false);
}
...
TYPED_TEST_P(TestStokesIntegrator, matrixintegratorstreamlmw_MPI)
{
  ...
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_matrixintegratorstream<false>();
  Fixture::options.prms.mesh.n_refinements = 2;
  Fixture::template check_matrixintegratorstream<false>();
}
*/
...
TYPED_TEST_P(TestStokesIntegrator, localsolverstream_velocity_MPI)
{
  ...
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::check_matrixintegratorstream();
...
TYPED_TEST_P(TestStokesIntegrator, simplified_matrixintegratorstreamlmw_MPI)
{
  ...
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_matrixintegratorstream<true>();
  Fixture::options.prms.mesh.n_refinements = 2;
  Fixture::template check_matrixintegratorstream<true>();
}
...
TYPED_TEST_P(TestStokesIntegrator, simplified_localsolverstream_velocity_MPI)
{
  using Fixture = TestStokesIntegrator<TypeParam>;
  Fixture::setup_matrixintegratorlmw();
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_matrixintegratorstream<true>();
  Fixture::template check_localsolverstream<true>(Fixture::lssVariant::Stream);
  Fixture::options.prms.mesh.n_repetitions = 3;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_localsolverstream<true>(Fixture::lssVariant::Stream);
  Fixture::options.prms.mesh.n_refinements = 1;
...
TYPED_TEST_P(TestStokesIntegrator, simplified_localsolverstream_gradp_MPI)
{
  using Fixture = TestStokesIntegrator<TypeParam>;
  Fixture::setup_matrixintegratorlmw();
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_localsolverstream<true>(Fixture::lssVariant::Gradp);
  Fixture::options.prms.mesh.n_repetitions = 3;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_localsolverstream<true>(Fixture::lssVariant::Gradp);
  Fixture::options.prms.mesh.n_refinements = 1;
...
TYPED_TEST_P(TestStokesIntegrator, simplified_localsolverstream_pressure_MPI)
{
  using Fixture = TestStokesIntegrator<TypeParam>;
  Fixture::setup_matrixintegratorlmw();
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_localsolverstream<true>(Fixture::lssVariant::Pressure);
  Fixture::options.prms.mesh.n_repetitions = 3;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::template check_localsolverstream<true>(Fixture::lssVariant::Pressure);
  Fixture::options.prms.mesh.n_refinements = 1;
...
TYPED_TEST_P(TestStokesIntegrator, simplified_matrixintegratorstreamfd_MPI)
{
  using Fixture = TestStokesIntegrator<TypeParam>;
  Fixture::setup_matrixintegratorlmw();
  Fixture::options.prms.mesh.n_repetitions = 2;
  Fixture::options.prms.mesh.n_refinements = 0;
  Fixture::equation_data.local_solver      = LocalSolver::C0IP;
  Fixture::template check_matrixintegratorstream<true, false>();
  Fixture::options.prms.mesh.n_refinements = 2;
  Fixture::template check_matrixintegratorstream<true, false>();
}
...
REGISTER_TYPED_TEST_SUITE_P(
  ...
  simplified_localsolverstream_gradp_MPI,
  simplified_localsolverstream_pressure_MPI,
  simplified_matrixintegratorstreamfd_MPI);
